...
USE cs;
CREATE TABLE user(id INT PRIMARY KEY AUTO_INCREMENT,username VARCHAR(50),password VARCHAR(50),nickname VARCHAR(50),created TIMESTAMP)CHARSET=UTF8;
...
INSERT INTO category VALUES (NULL,'精彩活动'),(NULL,'品牌男装'),(NULL,'数码科技'),(NULL,'母婴产品');
